$(function() {
    ...
    booking.forEach(function(item, index) {
      ...
      for (var m = 0; m < 16; m += 1) {
        if ($('form[name="Form"] #length_of_time').val() === 1 + 0.5 * m + '時間' && $('form[name="Form"] input').eq(266).val() !== "〇" && $('form[name="Form"] input').eq(266).val() !== "×") {
  ...
  $(function() {
    ...
    booking.forEach(function(item, index) {
      ...
      for (var m = 0; m < 16; m += 1) {
        if ($('form[name="Form2"] #length_of_time').val() === 1 + 0.5 * m + '時間' && $('form[name="Form2"] input').eq(266).val() !== "〇" && $('form[name="Form2"] input').eq(266).val() !== "×") {
          for (var k = 252-14 * m; k < 266; k++) {
