...
<div class="img-container">
    <picture>
        <source type="image/webp" srcset="{{ asset('image/woman6.webp') }}">
        <img id="woman5" src="image/woman6.png"  data-src="image/woman5.jpg" alt="seasons" class="main-img" data-srcset="image/woman6.jpg">
    </picture>
</div>
