...
{{--
    ...
    {{--  <div id="bkc2" class="delete">
        <div class="booking-btn-flame-pc text-center">
            <div class="booking-btn-container">
                <a class="booking-link" href="{{ action('HomeController@reservationPlan') }}"><button id="booking-btn-1" class="btn sub-button mt-3 text-center delete">予約へ進む</button></a>
            </div>
        </div>
        <div class="booking-btn-flame-sm text-center">
            <div class="booking-btn-container">
                <a class="justify-content-center" href="{{ action('HomeController@reservationPlanSM') }}"><button id="booking-btn-2" class="btn booking-btn mt-3 text-center delete">予約へ進む</button></a>
            </div>
        </div>
    </div>  --}}
        <div id="bkc0" class="booking-btn-flame text-center delete">
            <div class="booking-btn-container">
    ...
    <div id="bkc1" class="delete">
        ...
        <div class="booking-btn-flame-sm text-center">
            <div class="booking-btn-container">
                <a class="booking-link" href="{{ action('HomeController@reservationPlanSM') }}"><button id="booking-btn-5" class="btn booking-btn mt-3 text-center delete">予約へ進む</button></a>
            </div>
        </div>
    </div>
</div>
    ...
    <script>
        ...
        if(btn==0){
            document.getElementById('bkc0').classList.remove("delete");
        } else if(btn==1){
            document.getElementById('bkc1').classList.remove("delete");
        } else{
            document.getElementById('bkc2').classList.remove("delete");
        }
